...
import { EmailOptions, EmailTemplate } from '@/types/index.js';
...
export class EmailService {
  ...
  public static async sendEmail(options: EmailOptions): Promise<boolean> {
    try {
      ...
      logger.email('Email send failed', 
   ...
   */
  public static async sendPasswordChangedEmail(
    email: string, 
    name: string
  ): Promise<boolean> {
    return this.sendEmail({
   ...
   */
  public static async sendEnrollmentConfirmation(
    email: string,
    name: string,
    courseName: string,
    courseUrl: string
   ...
   */
  public static async sendCertificate(
    email: string,
    name: string,
    courseName: string,
   ...
   */
  public static async sendQuizCompletion(
    email: string,
    name: string,
    quizName: string,
    score: number,
   ...
   */
  public static async sendInstructorApplication(
    email: string,
    name: string,
   ...
   */
  public static async sendNewsletter(
    recipients: string[],
    subject: string,
    content: string
  ): Promise<boolean> {
