...
router.get('/',
  optionalAuthMiddleware,
  validateQuery(courseSchemas.browse),
...
router.get('/search',
  optionalAuthMiddleware,
  validateQuery(courseSchemas.search),
...
router.get('/:courseId/resources/:resourceId',
  authMiddleware,
  validateUuidParam('courseId'),
  validateUuidParam('resourceId'),
  requireCourseAccess,
...
router.post('/analyze-videos',
  authMiddleware,
  requireInstructorOrAdmin,
  courseController.analyzeVideosForPricing
);
...
router.patch('/:id/publish',
  ...
  requireInstructorOrAdmin,
  validateUuidParam('id'),
  courseController.toggleCoursePublication
);
...
router.post('/admin/bulk-action',
  authMiddleware,
  requireAdmin,
  courseController.bulkCourseAction
);
