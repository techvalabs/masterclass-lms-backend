...
export class CourseController {
  ...
  getCourses = async (req: Request, res: Response) => {
    try {
      ...
      const transformedCourses = (courses as any[]).map(course => ({
  ...
  getFreeCourses = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  getCoursesByCategory = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  getCoursePreview = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  getEnrollmentStatus = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  addCourseReview = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  updateCourseReview = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  deleteCourseReview = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  toggleCoursePublication = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  getAllCoursesAdmin = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  toggleCourseFeatured = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  bulkCourseAction = async (req: Request, res: Response) => {
    res.json({
      success: true,
  ...
  analyzeVideosForPricing = async (req: Request, res: Response) => {
    try {
      ...
      const modulesForAnalysis = modules.map((module: any) => ({
        id: module.id,
