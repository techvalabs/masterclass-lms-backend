...
export const cacheConfig = {
    ...
    keys: {
        user_session: (userId) => `${cacheConfig.prefix}user:session:${userId}`,
        course_data: (courseId) => `${cacheConfig.prefix}course:${courseId}`,
        enrollment_data: (userId, courseId) => `${cacheConfig.prefix}enrollment:${userId}:${courseId}`,
        progress_data: (userId, courseId) => `${cacheConfig.prefix}progress:${userId}:${courseId}`,
        quiz_results: (userId, quizId) => `${cacheConfig.prefix}quiz:results:${userId}:${quizId}`,
        analytics: (type, timeframe) => `${cacheConfig.prefix}analytics:${type}:${timeframe}`,
    },
};
